...
1.  `data/`: Contains raw data for the flow cytometry and microplate reader assays
    ...
    **The files can be labeled as PSEVA_BRANCO, PSEVA SP_BRANCO or PSEVA_GFP**

    1.2. `growth_curves/`: contains reading outputs (.txt) generated by the Victor X3 multilabel microplate reader, and corresponding plate maps (.xlsx) for analysis using the ad-hoc R package [mipreadr](github.com/viana-guilherme/mipreadr).
